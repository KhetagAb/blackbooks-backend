...
@Component
public class TempRepositoryInitializer {

    private TempRepositoryInitializer(@Autowired UserProfileRepository userProfileRepository,
        ...
        DepositoryEntry defdep = depositoryRepository.save(new DepositoryEntry("string",
                ...
                "string",
                "string"));
        System.out.println("dep: " + defdep.getId());
        System.out.println("user: " + defuser.getId());
