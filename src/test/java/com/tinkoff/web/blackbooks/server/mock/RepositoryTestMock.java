...
public class RepositoryTestMock {
    ...
    private RepositoryTestMock(@Autowired UserProfileRepository userProfileRepository,
        ...
        transactionEntries = List.of(
                transactionRepository.save(new TransactionEntity(null, khetag.getId(), itmo.getId(), "0", null, "rent", null)),
                transactionRepository.save(new TransactionEntity(null, khetag.getId(), itmo.getId(), "0", null, "rent", null)),
                transactionRepository.save(new TransactionEntity(null, khetag.getId(), itmo.getId(), "0", null, "rent", null)),
                transactionRepository.save(new TransactionEntity(null, khetag.getId(), itmo.getId(), "0", null, "returnal", null)),
                transactionRepository.save(new TransactionEntity(null, khetag.getId(), mipt.getId(), "0", null, "rent", null)),
                transactionRepository.save(new TransactionEntity(null, khetag.getId(), mipt.getId(), "0", null, "returnal", null)),
                transactionRepository.save(new TransactionEntity(null, ivan.getId(), itmo.getId(), "0", null, "rent", null)),
                transactionRepository.save(new TransactionEntity(null, ivan.getId(), itmo.getId(), "0", null, "rent", null)),
                transactionRepository.save(new TransactionEntity(null, ivan.getId(), itmo.getId(), "0", null, "rent", null)),
                transactionRepository.save(new TransactionEntity(null, ivan.getId(), mipt.getId(), "0", null, "rent", null)),

                transactionRepository.save(new TransactionEntity(null, defuser.getId(), defdep.getId(), "0", null, "1", null)),
                transactionRepository.save(new TransactionEntity(null, defuser.getId(), defdep.getId(), "0", null, "2", null)),
                transactionRepository.save(new TransactionEntity(null, defuser.getId(), defdep.getId(), "0", null, "3", null)),
                transactionRepository.save(new TransactionEntity(null, defuser.getId(), defdep.getId(), "0", null, "4", null)),
                transactionRepository.save(new TransactionEntity(null, defuser.getId(), defdep.getId(), "0", null, "5", null)),
                transactionRepository.save(new TransactionEntity(null, defuser.getId(), defdep.getId(), "0", null, "6", null)));
    }
}
